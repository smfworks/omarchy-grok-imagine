    ...
    return [
        {
            ...
            "content": (
                ...
                "When a rider's look is opposite his travel, write that he twists at the "
                "waist in the saddle, head and shoulders turned toward that side to face "
                "the pursuers, revolver arm extended back toward them, and the horse keeps "
                "galloping toward the travel side in side profile. "
                "Pursuers stay on horses in side profile, galloping toward the travel side. "
                "Do not turn their horses toward the camera. "
                "Pursuers drop farther behind, still riding. Do not write that they fall "
                "back, have fallen back, stop, halt, or stand still in the final shot "
                "unless the story says they do. "
                "A rider's own horse is part of that rider. Do not place the horse beside "
                "him as a separate entity. "
